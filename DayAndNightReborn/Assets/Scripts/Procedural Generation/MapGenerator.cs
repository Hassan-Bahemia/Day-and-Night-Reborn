    ...
    public class MapGenerator : MonoBehaviour
    {
        ...
        public void DrawMapInEditor()
        {
            ...
            if (drawMode == DrawMode.NoiseMap) {
                display.DrawTexture(MapTextureGenerator.TextureFromHeightMap(mapData.heightMap));
            }
        ...
        {
            float[,] noiseMap = NoiseMap.GenerateNoiseMap(mapChunkSize + 2, mapChunkSize + 2, noiseData.seed,
